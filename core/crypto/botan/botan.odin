...
// Not real values for Botan, only used for context setup within the crypto lib
HASH_SHA2        :: "SHA2"
HASH_SHA3        :: "SHA3"
HASH_SHAKE       :: "SHAKE"
HASH_KECCAK      :: "KECCAK"
...
foreign botan_lib {
    ...
    hex_encode                          :: proc(x: ^c.char, length: c.size_t, out: ^c.byte, flags: c.uint) -> c.int ---
    hex_decode                          :: proc(hex_str: cstring, in_len: c.size_t, out: ^c.byte, out_len: c.size_t) -> c.int ---

    base64_encode                       :: proc(x: ^c.char, length: c.size_t, out: ^c.byte, out_len: c.size_t) -> c.int ---
    base64_decode                       :: proc(base64_str: cstring, in_len: c.size_t, out: ^c.byte, out_len: c.size_t) -> c.int ---

    rng_init                            :: proc(rng: ^rng_t, rng_type: cstring) -> c.int ---
    rng_init_custom                     :: proc(rng_out: ^rng_t, rng_name: cstring, ctx: rawptr, 
                                                get_cb:         proc(ctx: rawptr, out: ^c.byte, out_len: c.size_t) -> ^c.int,
                                                add_entropy_cb: proc(ctx: rawptr, input: ^c.byte, length: c.size_t) -> ^c.int,
                                                destroy_cb:     proc(ctx: rawptr) -> rawptr) -> c.int ---
    rng_get                             :: proc(rng: rng_t, out: ^c.byte, out_len: c.size_t) -> c.int ---
    rng_reseed                          :: proc(rng: rng_t, bits: c.size_t) -> c.int ---
    rng_reseed_from_rng                 :: proc(rng, source_rng: rng_t, bits: c.size_t) -> c.int ---
    rng_add_entropy                     :: proc(rng: rng_t, entropy: ^c.byte, entropy_len: c.size_t) -> c.int ---
    ...
    hash_update                         :: proc(hash: hash_t, input: ^c.byte, input_len: c.size_t) -> c.int ---
    hash_final                          :: proc(hash: hash_t, out: ^c.byte) -> c.int ---
    hash_clear                          :: proc(hash: hash_t) -> c.int ---
    hash_destroy                        :: proc(hash: hash_t) -> c.int ---
    hash_name                           :: proc(hash: hash_t, name: ^c.byte, name_len: ^c.size_t) -> c.int ---
    ...
    mac_set_key                         :: proc(mac: mac_t, key: ^c.byte, key_len: c.size_t) -> c.int ---
    mac_update                          :: proc(mac: mac_t, buf: ^c.byte, length: c.size_t) -> c.int ---
    mac_final                           :: proc(mac: mac_t, out: ^c.byte) -> c.int ---
    mac_clear                           :: proc(mac: mac_t) -> c.int ---
    mac_name                            :: proc(mac: mac_t, name: ^c.byte, name_len: ^c.size_t) -> c.int ---
    ...
    cipher_name                         :: proc(cipher: cipher_t, name: ^c.byte, name_len: ^c.size_t) -> c.int ---
    ...
    cipher_set_key                      :: proc(cipher: cipher_t, key: ^c.byte, key_len: c.size_t) -> c.int ---
    cipher_reset                        :: proc(cipher: cipher_t) -> c.int ---
    cipher_set_associated_data          :: proc(cipher: cipher_t, ad: ^c.byte, ad_len: c.size_t) -> c.int ---
    cipher_start                        :: proc(cipher: cipher_t, nonce: ^c.byte, nonce_len: c.size_t) -> c.int ---
    cipher_update                       :: proc(cipher: cipher_t, flags: c.uint, output: ^c.byte, output_size: c.size_t, output_written: ^c.size_t, 
                                                input_bytes: ^c.byte, input_size: c.size_t, input_consumed: ^c.size_t) -> c.int ---
    cipher_clear                        :: proc(hash: cipher_t) -> c.int ---
    cipher_destroy                      :: proc(cipher: cipher_t) -> c.int ---

    @(deprecated="Use botan.pwdhash")
    pbkdf                               :: proc(pbkdf_algo: cstring, out: ^c.byte, out_len: c.size_t, passphrase: cstring, salt: ^c.byte,
                                                salt_len, iterations: c.size_t) -> c.int ---
    @(deprecated="Use botan.pwdhash_timed")
    pbkdf_timed                         :: proc(pbkdf_algo: cstring, out: ^c.byte, out_len: c.size_t, passphrase: cstring, salt: ^c.byte,
                                                salt_len, milliseconds_to_run: c.size_t, out_iterations_used: ^c.size_t) -> c.int ---
    pwdhash                             :: proc(algo: cstring, param1, param2, param3: c.size_t, out: ^c.byte, out_len: c.size_t, passphrase: cstring,
                                                passphrase_len: c.size_t, salt: ^c.byte, salt_len: c.size_t) -> c.int ---
    pwdhash_timed                       :: proc(algo: cstring, msec: c.uint, param1, param2, param3: c.size_t, out: ^c.byte, out_len: c.size_t,
                                                passphrase: cstring, passphrase_len: c.size_t, salt: ^c.byte, salt_len: c.size_t) -> c.int ---
    @(deprecated="Use botan.pwdhash")
    scrypt                              :: proc(out: ^c.byte, out_len: c.size_t, passphrase: cstring, salt: ^c.byte, salt_len, N, r, p: c.size_t) -> c.int ---
    kdf                                 :: proc(kdf_algo: cstring, out: ^c.byte, out_len: c.size_t, secret: ^c.byte, secret_lent: c.size_t, salt: ^c.byte,
                                                salt_len: c.size_t, label: ^c.byte, label_len: c.size_t) -> c.int ---
    ...
    block_cipher_set_key                :: proc(bc: block_cipher_t, key: ^c.byte, key_len: c.size_t) -> c.int ---
    block_cipher_block_size             :: proc(bc: block_cipher_t) -> c.int ---
    block_cipher_encrypt_blocks         :: proc(bc: block_cipher_t, input, out: ^c.byte, blocks: c.size_t) -> c.int ---
    block_cipher_decrypt_blocks         :: proc(bc: block_cipher_t, input, out: ^c.byte, blocks: c.size_t) -> c.int ---
    block_cipher_name                   :: proc(bc: block_cipher_t, name: ^c.byte, name_len: ^c.size_t) -> c.int ---
    ...
    mp_to_hex                           :: proc(mp: mp_t, out: ^c.byte) -> c.int ---
    mp_to_str                           :: proc(mp: mp_t, base: c.char, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    ...
    mp_to_bin                           :: proc(mp: mp_t, vec: ^c.byte) -> c.int ---
    mp_from_bin                         :: proc(mp: mp_t, vec: ^c.byte, vec_len: c.size_t) -> c.int ---
    ...
    bcrypt_generate                     :: proc(out: ^c.byte, out_len: ^c.size_t, password: cstring, rng: rng_t, work_factor: c.size_t, flags: c.uint) -> c.int --- 
    ...
    privkey_load                        :: proc(key: ^privkey_t, rng: rng_t, bits: ^c.byte, length: c.size_t, password: cstring) -> c.int ---
    privkey_destroy                     :: proc(key: privkey_t) -> c.int ---
    privkey_export                      :: proc(key: privkey_t, out: ^c.byte, out_len: ^c.size_t, flags: c.uint) -> c.int ---
    privkey_algo_name                   :: proc(key: privkey_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    @(deprecated="Use botan.privkey_export_encrypted_pbkdf_{msec,iter}")
    privkey_export_encrypted            :: proc(key: privkey_t, out: ^c.byte, out_len: ^c.size_t, rng: rng_t, passphrase, encryption_algo: cstring, flags: c.uint) -> c.int ---
    privkey_export_encrypted_pbkdf_msec :: proc(key: privkey_t, out: ^c.byte, out_len: ^c.size_t, rng: rng_t, passphrase: cstring, pbkdf_msec_runtime: c.uint,
                                                pbkdf_iterations_out: ^c.size_t, cipher_algo, pbkdf_algo: cstring, flags: c.uint) -> c.int ---
    privkey_export_encrypted_pbkdf_iter :: proc(key: privkey_t, out: ^c.byte, out_len: ^c.size_t, rng: rng_t, passphrase: cstring, pbkdf_iterations: c.size_t,
                                                cipher_algo, pbkdf_algo: cstring, flags: c.uint) -> c.int ---
    pubkey_load                         :: proc(key: ^pubkey_t, bits: ^c.byte, length: c.size_t) -> c.int ---
    privkey_export_pubkey               :: proc(out: ^pubkey_t, input: privkey_t) -> c.int ---
    pubkey_export                       :: proc(key: pubkey_t, out: ^c.byte, out_len: ^c.size_t, flags: c.uint) -> c.int ---
    pubkey_algo_name                    :: proc(key: pubkey_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    ...
    pubkey_fingerprint                  :: proc(key: pubkey_t, hash: cstring, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    ...
    privkey_load_rsa_pkcs1              :: proc(key: ^privkey_t, bits: ^c.byte, length: c.size_t) -> c.int ---
    ...
    privkey_rsa_get_privkey             :: proc(rsa_key: privkey_t, out: ^c.byte, out_len: ^c.size_t, flags: c.uint) -> c.int ---
    ...
    privkey_load_ed25519                :: proc(key: ^privkey_t, privkey: [32]c.byte) -> c.int ---
    pubkey_load_ed25519                 :: proc(key: ^pubkey_t, pubkey: [32]c.byte) -> c.int ---
    privkey_ed25519_get_privkey         :: proc(key: ^privkey_t, output: [64]c.byte) -> c.int ---
    pubkey_ed25519_get_pubkey           :: proc(key: ^pubkey_t, pubkey: [32]c.byte) -> c.int ---

    privkey_load_x25519                 :: proc(key: ^privkey_t, privkey: [32]c.byte) -> c.int ---
    pubkey_load_x25519                  :: proc(key: ^pubkey_t, pubkey: [32]c.byte) -> c.int ---
    privkey_x25519_get_privkey          :: proc(key: ^privkey_t, output: [32]c.byte) -> c.int ---
    pubkey_x25519_get_pubkey            :: proc(key: ^pubkey_t, pubkey: [32]c.byte) -> c.int ---
    ...
    pubkey_sm2_compute_za               :: proc(out: ^c.byte, out_len: ^c.size_t, ident, hash_algo: cstring, key: pubkey_t) -> c.int ---
    ...
    pk_op_encrypt                       :: proc(op: pk_op_encrypt_t, rng: rng_t, out: ^c.byte, out_len: ^c.size_t, plaintext: cstring, plaintext_len: c.size_t) -> c.int ---
    ...
    pk_op_decrypt                       :: proc(op: pk_op_decrypt_t, rng: rng_t, out: ^c.byte, out_len: ^c.size_t, ciphertext: cstring, ciphertext_len: c.size_t) -> c.int ---
    ...
    pk_op_sign_update                   :: proc(op: pk_op_sign_t, input: ^c.byte, input_len: c.size_t) -> c.int ---
    pk_op_sign_finish                   :: proc(op: pk_op_sign_t, rng: rng_t, sig: ^c.byte, sig_len: ^c.size_t) -> c.int ---
    ...
    pk_op_verify_update                 :: proc(op: pk_op_verify_t, input: ^c.byte, input_len: c.size_t) -> c.int ---
    pk_op_verify_finish                 :: proc(op: pk_op_verify_t, sig: ^c.byte, sig_len: c.size_t) -> c.int ---
    ...
    pk_op_key_agreement_export_public   :: proc(key: privkey_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    pk_op_key_agreement_size            :: proc(op: pk_op_ka_t, out_len: ^c.size_t) -> c.int ---
    pk_op_key_agreement                 :: proc(op: pk_op_ka_t, out: ^c.byte, out_len: ^c.size_t, other_key: ^c.byte, other_key_len: c.size_t, salt: ^c.byte,
                                                salt_len: c.size_t) -> c.int ---

    pkcs_hash_id                        :: proc(hash_name: cstring, pkcs_id: ^c.byte, pkcs_id_len: ^c.size_t) -> c.int ---

    @(deprecated="Poorly specified, avoid in new code")
    mceies_encrypt                      :: proc(mce_key: pubkey_t, rng: rng_t, aead: cstring, pt: ^c.byte, pt_len: c.size_t, ad: ^c.byte, ad_len: c.size_t,
                                                ct: ^c.byte, ct_len: ^c.size_t) -> c.int ---
    @(deprecated="Poorly specified, avoid in new code")
    mceies_decrypt                      :: proc(mce_key: privkey_t, aead: cstring, ct: ^c.byte, ct_len: c.size_t, ad: ^c.byte, ad_len: c.size_t, pt: ^c.byte,
                                                pt_len: ^c.size_t) -> c.int ---

    x509_cert_load                      :: proc(cert_obj: ^x509_cert_t, cert: ^c.byte, cert_len: c.size_t) -> c.int ---
    ...
    x509_cert_get_time_starts           :: proc(cert: x509_cert_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_get_time_expires          :: proc(cert: x509_cert_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    ...
    x509_cert_get_fingerprint           :: proc(cert: x509_cert_t, hash: cstring, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_get_serial_number         :: proc(cert: x509_cert_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_get_authority_key_id      :: proc(cert: x509_cert_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_get_subject_key_id        :: proc(cert: x509_cert_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_get_public_key_bits       :: proc(cert: x509_cert_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_get_public_key            :: proc(cert: x509_cert_t, key: ^pubkey_t) -> c.int ---
    x509_cert_get_issuer_dn             :: proc(cert: x509_cert_t, key: ^c.byte, index: c.size_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_get_subject_dn            :: proc(cert: x509_cert_t, key: ^c.byte, index: c.size_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    x509_cert_to_string                 :: proc(cert: x509_cert_t, out: ^c.byte, out_len: ^c.size_t) -> c.int ---
    ...
    x509_crl_load                       :: proc(crl_obj: ^x509_crl_t, crl_bits: ^c.byte, crl_bits_len: c.size_t) -> c.int ---
    ...
    key_wrap3394                        :: proc(key: ^c.byte, key_len: c.size_t, kek: ^c.byte, kek_len: c.size_t, wrapped_key: ^c.byte, wrapped_key_len: ^c.size_t) -> c.int ---
    key_unwrap3394                      :: proc(wrapped_key: ^c.byte, wrapped_key_len: c.size_t, kek: ^c.byte, kek_len: c.size_t, key: ^c.byte, key_len: ^c.size_t) -> c.int ---

    hotp_init                           :: proc(hotp: ^hotp_t, key: ^c.byte, key_len: c.size_t, hash_algo: cstring, digits: c.size_t) -> c.int ---
    ...
    totp_init                           :: proc(totp: ^totp_t, key: ^c.byte, key_len: c.size_t, hash_algo: cstring, digits, time_step: c.size_t) -> c.int ---
    ...
    fpe_fe1_init                        :: proc(fpe: ^fpe_t, n: mp_t, key: ^c.byte, key_len, rounds: c.size_t, flags: c.uint) -> c.int ---
    fpe_destroy                         :: proc(fpe: fpe_t) -> c.int ---
    fpe_encrypt                         :: proc(fpe: fpe_t, x: mp_t, tweak: ^c.byte, tweak_len: c.size_t) -> c.int ---
    fpe_decrypt                         :: proc(fpe: fpe_t, x: mp_t, tweak: ^c.byte, tweak_len: c.size_t) -> c.int ---
}