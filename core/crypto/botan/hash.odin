...
hash_file_16 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([16]byte, os.Errno) {
...
hash_file_20 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([20]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_file_24 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([24]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_file_28 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([28]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_file_32 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([32]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_file_48 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([48]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_file_64 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([64]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_file_128 :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string) -> ([128]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_file_slice :: #force_inline proc(ctx: ^_ctx.Hash_Context, path: string, bit_size: int, allocator := context.allocator) -> ([]byte, os.Errno) {
    if hd, err := os.open(path); err == os.ERROR_NONE {
...
hash_stream_16 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([16]byte, os.Errno) {
    hash: [16]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._16, 16), 0)
    buf := make([]byte, 512)
...
hash_stream_20 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([20]byte, os.Errno) {
    hash: [20]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._20, 20), 0)
    buf := make([]byte, 512)
...
hash_stream_24 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([24]byte, os.Errno) {
    hash: [24]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._24, 24), 0)
    buf := make([]byte, 512)
...
hash_stream_28 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([28]byte, os.Errno) {
    hash: [28]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._28, 28), 0)
    buf := make([]byte, 512)
...
hash_stream_32 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([32]byte, os.Errno) {
    hash: [32]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._32, 32), 0)
    buf := make([]byte, 512)
...
hash_stream_48 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([48]byte, os.Errno) {
    hash: [48]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._48, 48), 0)
    buf := make([]byte, 512)
...
hash_stream_64 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([64]byte, os.Errno) {
    hash: [64]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._64, 64), 0)
    buf := make([]byte, 512)
...
hash_stream_128 :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream) -> ([128]byte, os.Errno) {
    hash: [128]byte
    c: hash_t
    hash_init(&c, _check_ctx(ctx, _ctx.Hash_Size._128, 128), 0)
    buf := make([]byte, 512)
...
hash_stream_slice :: #force_inline proc(ctx: ^_ctx.Hash_Context, s: io.Stream, bit_size: int, allocator := context.allocator) -> ([]byte, os.Errno) {
    hash := make([]byte, bit_size, allocator)
    c: hash_t
    hash_init(&c, _check_ctx(ctx, nil, bit_size), 0)
    buf := make([]byte, 512)
