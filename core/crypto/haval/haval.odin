...
@(private)
_create_haval_ctx :: #force_inline proc(size: ctx.Hash_Size, rounds: u32) {
    ctx: Haval_Context
    ctx.rounds              = rounds
...
hash_stream_128_3 :: proc(s: io.Stream) -> ([16]byte, os.Errno) {
    _create_haval_ctx(._16, 3)
...
hash_file_128_3 :: proc(path: string) -> ([16]byte, os.Errno) {
    _create_haval_ctx(._16, 3)
...
// hash from its contents
hash_stream_128_4 :: proc(s: io.Stream) -> ([16]byte, os.Errno) {
    _create_haval_ctx(._16, 4)
    return _hash_impl->hash_stream_16(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_128_4 :: proc(path: string) -> ([16]byte, os.Errno) {
    _create_haval_ctx(._16, 4)
    return _hash_impl->hash_file_16(path)
}
...
// hash from its contents
hash_stream_128_5 :: proc(s: io.Stream) -> ([16]byte, os.Errno) {
    _create_haval_ctx(._16, 5)
    return _hash_impl->hash_stream_16(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_128_5 :: proc(path: string) -> ([16]byte, os.Errno) {
    _create_haval_ctx(._16, 5)
    return _hash_impl->hash_file_16(path)
}
...
// hash from its contents
hash_stream_160_3 :: proc(s: io.Stream) -> ([20]byte, os.Errno) {
    _create_haval_ctx(._20, 3)
...
// path and pass it to hash_stream to compute a hash
hash_file_160_3 :: proc(path: string) -> ([20]byte, os.Errno) {
    _create_haval_ctx(._20, 3)
...
// hash from its contents
hash_stream_160_4 :: proc(s: io.Stream) -> ([20]byte, os.Errno) {
    _create_haval_ctx(._20, 4)
    return _hash_impl->hash_stream_20(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_160_4 :: proc(path: string) -> ([20]byte, os.Errno) {
    _create_haval_ctx(._20, 4)
    return _hash_impl->hash_file_20(path)
}
...
// hash from its contents
hash_stream_160_5 :: proc(s: io.Stream) -> ([20]byte, os.Errno) {
    _create_haval_ctx(._20, 5)
    return _hash_impl->hash_stream_20(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_160_5 :: proc(path: string) -> ([20]byte, os.Errno) {
    _create_haval_ctx(._20, 5)
    return _hash_impl->hash_file_20(path)
}
...
// hash from its contents
hash_stream_192_3 :: proc(s: io.Stream) -> ([24]byte, os.Errno) {
    _create_haval_ctx(._24, 3)
...
// path and pass it to hash_stream to compute a hash
hash_file_192_3 :: proc(path: string) -> ([24]byte, os.Errno) {
    _create_haval_ctx(._24, 3)
...
// hash from its contents
hash_stream_192_4 :: proc(s: io.Stream) -> ([24]byte, os.Errno) {
    _create_haval_ctx(._24, 4)
    return _hash_impl->hash_stream_24(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_192_4 :: proc(path: string) -> ([24]byte, os.Errno) {
    _create_haval_ctx(._24, 4)
    return _hash_impl->hash_file_24(path)
}
...
// hash from its contents
hash_stream_192_5 :: proc(s: io.Stream) -> ([24]byte, os.Errno) {
    _create_haval_ctx(._24, 5)
    return _hash_impl->hash_stream_24(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_192_5 :: proc(path: string) -> ([24]byte, os.Errno) {
    _create_haval_ctx(._24, 5)
    return _hash_impl->hash_file_24(path)
}
...
// hash from its contents
hash_stream_224_3 :: proc(s: io.Stream) -> ([28]byte, os.Errno) {
    _create_haval_ctx(._28, 3)
...
// path and pass it to hash_stream to compute a hash
hash_file_224_3 :: proc(path: string) -> ([28]byte, os.Errno) {
    _create_haval_ctx(._28, 3)
...
// hash from its contents
hash_stream_224_4 :: proc(s: io.Stream) -> ([28]byte, os.Errno) {
    _create_haval_ctx(._28, 4)
    return _hash_impl->hash_stream_28(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_224_4 :: proc(path: string) -> ([28]byte, os.Errno) {
    _create_haval_ctx(._28, 4)
    return _hash_impl->hash_file_28(path)
}
...
// hash from its contents
hash_stream_224_5 :: proc(s: io.Stream) -> ([28]byte, os.Errno) {
    _create_haval_ctx(._28, 5)
    return _hash_impl->hash_stream_28(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_224_5 :: proc(path: string) -> ([28]byte, os.Errno) {
    _create_haval_ctx(._28, 5)
    return _hash_impl->hash_file_28(path)
}
...
// hash from its contents
hash_stream_256_3 :: proc(s: io.Stream) -> ([32]byte, os.Errno) {
    _create_haval_ctx(._32, 3)
...
// path and pass it to hash_stream to compute a hash
hash_file_256_3 :: proc(path: string) -> ([32]byte, os.Errno) {
    _create_haval_ctx(._32, 3)
...
// hash from its contents
hash_stream_256_4 :: proc(s: io.Stream) -> ([32]byte, os.Errno) {
    _create_haval_ctx(._32, 4)
    return _hash_impl->hash_stream_32(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_256_4 :: proc(path: string) -> ([32]byte, os.Errno) {
    _create_haval_ctx(._32, 4)
    return _hash_impl->hash_file_32(path)
}
...
// hash from its contents
hash_stream_256_5 :: proc(s: io.Stream) -> ([32]byte, os.Errno) {
    _create_haval_ctx(._32, 5)
    return _hash_impl->hash_stream_32(s)
}
...
// path and pass it to hash_stream to compute a hash
hash_file_256_5 :: proc(path: string) -> ([32]byte, os.Errno) {
    _create_haval_ctx(._32, 5)
    return _hash_impl->hash_file_32(path)
}
