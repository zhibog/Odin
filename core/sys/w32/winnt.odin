...
PROCESSOR_IDLESTATE_POLICY_Flags :: bit_field #align align_of(WORD) {
	AllowScaling : 1-0,
	Disabled : 2-1,
	Reserved : 16-2,
}
...
PROCESSOR_POWER_POLICY_INFO :: bit_field #align align_of(DWORD) {
	AllowDemotion : 1-0,
	AllowPromotion : 2-1,
	Reserved : 32-2,
}
...
PROCESSOR_PERFSTATE_POLICY_u_Flags :: bit_field #align align_of(BYTE) {
...
IMAGE_TLS_DIRECTORY64 :: bit_field #align align_of(DWORD) {
	Reserved0 : 20-0,
	Alignment : 24-20,
	Reserved1 : 32-24,
}
...
IMAGE_TLS_DIRECTORY32 :: bit_field #align align_of(DWORD) {
	Reserved0 : 20-0,
	Alignment : 24-20,
	Reserved1 : 32-24,
}
...
IMAGE_DELAYLOAD_DESCRIPTOR_Attributes :: bit_field #align align_of(DWORD) {
	RvaBased : 1-0,
...
IMAGE_RESOURCE_DIRECTORY_ENTRY :: bit_field #align align_of(DWORD) {
...
IMAGE_ARM_RUNTIME_FUNCTION_ENTRY :: bit_field #align align_of(DWORD) {
	Flag : 2-0,
	FunctionLength : 13-2,
	Ret : 15-13,
	H : 16-15,
...
IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY :: bit_field #align align_of(DWORD) {
	Flag : 2-0,
	FunctionLength : 13-2,
	RegF : 16-13,
	RegI : 20-16,
...
SLIST_HEADER_HeaderX64 :: bit_field #align align_of(ULONGLONG) {
	Depth : 16-0,
	Sequence : 64-16,
}
SLIST_HEADER_HeaderX64 :: bit_field #align align_of(ULONGLONG) {
